...
//             className="p-5 bg-white/40 rounded-3xl backdrop-blur-xl border shadow hover:shadow-xl transition-all"
//           >
...
//                   Tenant:{" "}
//                   <span className="font-bold">{req.tenantId?.name}</span>
//                 </p>
...
//         <p className="text-center text-gray-600">No rented properties yet.</p>
//       )}
//     </div>
//   );
// }
