...
// ⭐ Your SAME Header & Footer used on all tenant pages
...
export default function TenantPropertyDetailsPage() {
  ...
  return (
    <>
      {/* ⭐ SAME HEADER AS ALL TENANT PAGES */}
      <Header />
              ...
              <div className="glass-card p-6 rounded-2xl border border-white/30 shadow-lg bg-green-50/50">
                ...
                {property.status === "rented" ? (
                  ...
                  <button
                    ...
                    className="w-full mt-4 px-5 py-2.5 rounded-full text-sm glass-btn-blue"
                  >
                    View Request Status
                  </button>
                ) : (
      ...
      {/* ⭐ SAME FOOTER AS OTHER TENANT PAGES */}
      <Footer />
    </>
  );
}
